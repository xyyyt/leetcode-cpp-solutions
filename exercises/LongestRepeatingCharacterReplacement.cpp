...
int main()
{
    ...
    assert(Solution().characterReplacement("ABBBBABBA", 0) == 4);
    assert(Solution().characterReplacement("AAAA", 2) == 4);
    assert(Solution().characterReplacement("ABCD", 0) == 1);
    assert(Solution().characterReplacement("ABABABAB", 3) == 7);
    assert(Solution().characterReplacement("BAAAB", 2) == 5);
    assert(Solution().characterReplacement("Z", 10) == 1);
    assert(Solution().characterReplacement("", 5) == 0);
    assert(Solution().characterReplacement("ABCDE", 100) == 5);
    assert(Solution().characterReplacement("ABBBACCCCD", 1) == 5);
