...
int main()
{
...

    {
        ...
        assert(Solution().maxPathSum(root) == 43);
    }

    {
        ...
        assert(Solution().maxPathSum(root) == 31);
    }

    {
        ...
        assert(Solution().maxPathSum(root) == 444);
    }

    {
        ...
        assert(Solution().maxPathSum(root) == 85);
    }

    {
        assert(Solution().maxPathSum(new TreeNode(18)) == 18);
    }
